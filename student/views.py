...
def home(request):
	...
	book10=Books.objects.all().filter(bgrade__forgrade=10,visible=True)
	book11=Books.objects.all().filter(bgrade__forgrade=11,visible=True)
	book12=Books.objects.all().filter(bgrade__forgrade=12,visible=True)
