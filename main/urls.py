...
path("Scompexamlist/<str:grd>/<str:mil>",views.Fcompexamlist,name="filteredcompetitiveexamlist-api"),
...
path("Scompexattresult/<str:sid>/<str:xid>/<str:mid>/<str:std>/<str:pnt>/<str:crt>/<str:wrng>/<str:ename>",views.Compexaddresult,name="ocmpexamattendedlist-api"),
path("Scompexattresulttempo/<str:sid>/<str:xid>/<str:mid>/<str:std>/<str:ename>",views.Compexaddtemporesult,name="ocmpexamattendedtemplist-api"),
